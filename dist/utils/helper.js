...
export async function createThumbnail(userId, bgImageUrl, profileImageUrl, fullName, from, bio, age, profession, study, username) {
    try {
        ...
        drawRoundedRect(ctx, detailsX - 25, detailsY - 25, detailsBoxWidth, detailsBoxHeight, 35, "rgba(0, 0, 0, 0.4)");
        ctx.strokeStyle = "rgba(211, 211, 211, 0.4)";
        ctx.lineWidth = 2;
        drawRoundedRect(ctx, detailsX - 25, detailsY - 25, detailsBoxWidth, detailsBoxHeight, 35, "transparent");
        // Full Name
